...
export default class CityList extends React.Component{
		...
		return (
			<div className="city-list-container">
				...
				<ul className="clear-fix">
	                ...
	                <li>
	                    <span onClick={this.changeCity.bind(this,'苏州')}>苏州</span>
	                </li>
	                <li>
	                ...
	                <li>
	                    <span onClick={this.changeCity.bind(this,'天津')}>天津</span>
	                </li>
	                <li>
	                    <span onClick={this.changeCity.bind(this,'重庆')}>重庆</span>
	                </li>
	                <li>
	                    <span onClick={this.changeCity.bind(this,'厦门')}>厦门</span>
	                </li>
	                <li>
	                    <span onClick={this.changeCity.bind(this,'武汉')}>武汉</span>
	                </li>
	                <li>
	                    <span onClick={this.changeCity.bind(this,'西安')}>西安</span>
	                </li>
	            </ul>
	        </div>
		)
	...
	changeCity(cityName){
		this.props.clickChange(cityName)
	}
